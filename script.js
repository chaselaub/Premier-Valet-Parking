...
document.querySelectorAll('.pricing-card .btn').forEach(button => {
    button.addEventListener('click', function() {
        ...
        showNotification(`Thank you for choosing our ${planName} plan! We'll contact you shortly.`, 'success');
    });
});
...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.service-card, .location-card, .pricing-card');
